...
Source contract: `Static-Site-Generator-Design.md` (repo root).
These are the distilled, binding requirements.

- Pandoc-based SSG (pandoc owns parsing, metadata, templates, math, AST transforms via Lua filters).
  Kernel owns only: scanning, classification, validation, routing, pandoc invocation, copying, manifest emission, CLI ergonomics.
